...
class Entry extends Component
{
    ...
    loadAndSaveProfile () {
        ...
        .then((cb) => {
            ...
            {
                case 200:
                    this.setState({photo: localStorage.root_url + cb.data.avatar, gender: cb.data.gender, id: cb.data.id, major: cb.data.major, name: cb.data.name});
                    break;
                default:
    ...
    render () {
        ...
        return (
            <div className={css.profilePaper}>
                    ...
                    <div style={{float: 'left'}}>
                        <div className={css.photo}>
                            ...
                            <div style={{marginTop: "10px", display: "flex"}}>
                                <RaisedButton style={{margin: "auto"}} label="上传图片" primary={true} onClick={this.handleUploadImage}/>
                            </div>
                        </div>
                ...
                >
                    <AvatarPicker image={this.state.uploadedFile} setEditorRef={this.setEditorRef} handleSave={this.handleSave}/>
                </Dialog>
                <input type="file" id="file" accept=".jpg, .jpeg, .png, .bmp" ref="fileUploader" style={{display: "none"}} onChange={this.handleFileBrowser}/>
            </div>
        );
    }
}
